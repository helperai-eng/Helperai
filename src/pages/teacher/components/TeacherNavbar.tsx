...
import { Brain, Users, BarChart2, FileText, LogOut, Menu, X } from 'lucide-react';
...
const TeacherNavbar: React.FC = () => {
  ...
  const navLinks = [
    { path: '/teacher', icon: <BarChart2 className="h-5 w-5" />, label: 'Dashboard' },
    { path: '/teacher/materials', icon: <FileText className="h-5 w-5" />, label: 'Review Materials' },
  ];
